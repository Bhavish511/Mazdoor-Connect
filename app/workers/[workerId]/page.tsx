        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <Breadcrumb className="mb-6">
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbLink asChild>
                  <Link href={`/categories/${worker.category}`}>
                    ...
                    <CardContent>
                      <Accordion type="single" collapsible className="w-full">
                        <AccordionItem value="cnic">
                          ...
                          <AccordionContent>
                            <p className="text-muted-foreground">
                              Identity verified through CNIC documentation.
                            </p>
                          </AccordionContent>
                        </AccordionItem>
                        <AccordionItem value="police">
                          ...
                          <AccordionContent>
                            <p className="text-muted-foreground">
                              Background check completed through police
                              verification system.
                            </p>
                          </AccordionContent>
                        </AccordionItem>
                        <AccordionItem value="skill">
                          ...
                          <AccordionContent>
                            <p className="text-muted-foreground">
                              Practical skill assessment completed and passed.
                            </p>
                          </AccordionContent>
                        </AccordionItem>
                      </Accordion>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      ...
                      <p className="text-sm text-muted-foreground mt-4">
                        Note: Final price depends on complexity and parts
                        required.
                      </p>
                    </CardContent>
                  </Card>
